...
- hosts: ${MASTER_HOST}
  ...
  tasks:
    - name: download postgresql db
      get_url:
        url: https://github.com/xqianwang/micro-message/releases/download/1.3.1/database-1.3.1.tar.gz
...
- hosts: ${MASTER_HOST}
  ...
  tasks:
    - name: download micro-message app openshift files
      get_url:
        url: https://github.com/xqianwang/micro-message/releases/download/1.3.1/micro-message-1.3.1.tar.gz
